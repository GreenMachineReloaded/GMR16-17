...
@Autonomous(name="hit beacon red second")
@Disabled
public class SecondBeaconRed extends LinearOpMode{
    public void runOpMode() throws InterruptedException {
        ...
        move.colorWhiteDrive(Directions.DRightUp, 25, ColorSensors.whichColorSensor.GROUNDLEFT);

        move.ProxDrive(Directions.Forward, 25, .7);

        move.colorDriveRedBlue(Directions.StrafeLeft, 25, ColorSensors.whichColorSensor.BEACON, ColorSensors.whichColor.RED);
